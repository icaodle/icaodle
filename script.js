  ...
  if (!finished && !isEndScreenOpen && !animatingBox && !menuOpen) {
    ...
    if (qwerty.includes(key) == true) {
      ...
      if (box == box.parentElement.lastChild && box.textContent != "") {
        ...
        if (
          airportArray.includes(guess) &&
          guessedCodes.includes(guess) != true
        ) {
          let fluidAnswer = [];
          ...
          correctCount = 0;
          for (let i = 0; i < box.parentElement.children.length; i++) {
            box.parentElement.children[i].style.transition =
              "transform " +
              (i * durationModif + 1) +
              "s ease-in-out, background-color 0.2s " +
              (i * durationModif + 0.8) +
              "s, border-color 0.2s " +
              (i * durationModif + 0.8) +
              "s, color 0.2s " +
              (i * durationModif + 0.8) +
              "s";
            box.parentElement.children[i].style.transform =
              "rotate3d(1,0,0," + Math.round((i + 3) * 360) + "deg)";
            if (!animatingBox) {
              animatingBox = true;
              window.setTimeout(function () {
                animatingBox = false;
              }, 3000 * durationModif + 1000);
            }
            ...
            if (guess == fluidAnswer[i]) {
              box.parentElement.children[i].style.backgroundColor =
                "var(--green)";
              ...
              guess != fluidAnswer[i] &&
              fluidAnswer.includes(guess) == true
            ) {
              let location = fluidAnswer.indexOf(guess);
              if (
                box.parentElement.children[location].textContent !=
                fluidAnswer[location]
              ) {
                box.parentElement.children[i].style.backgroundColor =
                  "var(--yellow)";
                box.parentElement.children[i].style.borderColor =
                  "var(--yellow)";
                box.parentElement.children[i].style.color = "white";
                if (
                  document.getElementById(guess).style.backgroundColor !=
                  ...
                  document.getElementById(guess).style.backgroundColor =
                    "var(--yellow)";
                  document.getElementById(guess).style.borderColor =
                    "var(--yellow)";
                  document.getElementById(guess).style.color = "white";
                }
                fluidAnswer[location] = "";
          ...
          target_row += 1;
          if (
            target_row == box.parentElement.parentElement.children.length ||
            correctCount == 4
          ) {
            finished = true;
          }
          ...
          if (
            typeof document.getElementById("not_a_code_msg") == "undefined" ||
            document.getElementById("not_a_code_msg") == null
          ) {
            ...
            if (guessedCodes.includes(guess)) {
              ...
              if (
                airportArray == intlCodesArray &&
                allCodesArray.includes(guess)
              ) {
                error.textContent =
                  "Only Intl. Codes Allowed. See settings to change.";
              } else {
            ...
            error.style.left =
              (document.body.clientWidth + 15) / 2 -
              error.clientWidth / 2 +
              "px";
